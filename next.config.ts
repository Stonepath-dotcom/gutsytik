        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "connect-src 'self' https://pagead2.googlesyndication.com https://googleads.g.doubleclick.net https://www.google.com https://*.onrender.com https://*.railway.app https://*.up.railway.app https://*.replit.app https://*.replit.dev",
              "font-src 'self'",
              "media-src 'self' blob: https://*.onrender.com https://*.railway.app https://*.up.railway.app https://*.replit.app https://*.replit.dev https://*.googlevideo.com",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
            ].join("; "),
