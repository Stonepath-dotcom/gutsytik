        ...
        headers: [
          ...
          },
          {
            ...
            value: [
              ...
              "font-src 'self'",
              "media-src 'self' blob: https://*.onrender.com https://*.railway.app https://*.up.railway.app https://*.replit.app https://*.replit.dev https://*.googlevideo.com https://*.workers.dev https://*.deno.dev https://*.deno.land",
              "object-src 'none'",
              "base-uri 'self'",
              "form-action 'self'",
            ].join("; "),
