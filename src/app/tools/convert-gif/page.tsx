          ...
          <div className="mx-auto max-w-5xl px-4 pt-6">
            <nav aria-label="Breadcrumb">
              <ol className="flex items-center gap-1.5 text-sm text-muted-foreground">
                ...
                <li><ChevronRight className="h-3.5 w-3.5" /></li>
                <li className="text-[#E52222] font-medium">Convert ke GIF</li>
              </ol>
            </nav>
          </div>
          ...
          <section className="relative pt-8 pb-10 px-4 sm:px-6">
            ...
            <div className="relative mx-auto max-w-4xl text-center">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#E52222]/10 border border-[#E52222]/20 mb-4">
                <Image className="h-3.5 w-3.5 text-[#E52222]" />
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                {[
                  ...
                  <div key={s.step} className="p-5 rounded-2xl bg-card border border-border text-center">
                    <div className="w-10 h-10 rounded-full bg-[#E52222]/10 text-[#E52222] font-bold flex items-center justify-center mx-auto mb-3">{s.step}</div>
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="grid sm:grid-cols-3 gap-3">
                ...
                <Link href="/tools/trim-video" className="p-4 rounded-xl bg-card border border-border hover:border-[#E52222]/30 transition-all group">
                  ...
                  <p className="text-sm font-semibold text-foreground group-hover:text-[#E52222]">Trim Video</p>
