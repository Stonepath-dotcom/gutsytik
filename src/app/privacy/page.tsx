        ...
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-4xl sm:text-5xl font-light tracking-tight text-foreground mb-4 mt-4">
              Kebijakan Privasi &{" "}
              <span className="font-bold text-[#E52222]">Syarat Ketentuan</span>
            </h1>
          ...
          <div className="mb-12 p-6 rounded-xl bg-card border border-[#E52222]/30">
            <div className="flex items-center gap-3 mb-3">
              ...
              <h2 className="text-base font-bold text-foreground">Pemberitahuan Google AdSense</h2>
            </div>
          ...
          <div className="mt-16 pt-8 border-t border-border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <a href="/terms" className="flex items-center justify-between p-4 rounded-lg border border-border bg-card hover:border-[#E52222]/50 transition-colors group">
                ...
                <span className="text-muted-foreground group-hover:text-[#E52222] transition-colors">&rarr;</span>
              </a>
              ...
              <a href="/disclaimer" className="flex items-center justify-between p-4 rounded-lg border border-border bg-card hover:border-[#E52222]/50 transition-colors group">
                <span className="text-sm text-muted-foreground group-hover:text-foreground dark:group-hover:text-[#FAFAFA]">Disclaimer</span>
                <span className="text-muted-foreground group-hover:text-[#E52222] transition-colors">&rarr;</span>
              </a>
              <a href="/dmca" className="flex items-center justify-between p-4 rounded-lg border border-border bg-card hover:border-[#E52222]/50 transition-colors group">
                <span className="text-sm text-muted-foreground group-hover:text-foreground dark:group-hover:text-[#FAFAFA]">DMCA</span>
                <span className="text-muted-foreground group-hover:text-[#E52222] transition-colors">&rarr;</span>
              </a>
            </div>
          </div>
