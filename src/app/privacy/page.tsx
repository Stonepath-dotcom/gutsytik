...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "If you believe your copyrighted content is being accessed in violation of your rights, please contact us at support@movadl.vercel.app with the URL in question and proof of ownership.",
    ],
  },
  {
    icon: Shield,
  ...
  },
  {
    ...
    content: [
      ...
      "Email: support@movadl.vercel.app",
      "TikTok: @abbbuw",
      "Telegram: @sixte3nnn",
    ],
  },
