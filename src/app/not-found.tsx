...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-white dark:bg-[#09090B] relative overflow-hidden px-4">
      ...
      <div className="relative z-10 text-center max-w-lg">
        ...
        {/* Message */}
        <h2 className="text-2xl sm:text-3xl font-bold text-foreground dark:text-[#FAFAFA] mb-3">
          Oops! Page Not Found
        </h2>
        <p className="text-muted-foreground dark:text-[#A1A1AA] text-base sm:text-lg mb-2">
          Halaman yang kamu cari udah hilang di dunia digital
        </p>
        <p className="text-muted-foreground/70 dark:text-[#A1A1AA]/70 text-sm mb-10">
