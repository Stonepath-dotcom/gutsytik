        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-1.5">
              ...
              <div className="w-24 h-9 rounded-lg bg-primary/20 animate-pulse" style={{ animationDelay: "300ms" }} />
            </div>
      ...
      <main className="flex-1 pt-16 flex items-center justify-center">
        <div className="text-center px-6 max-w-2xl mx-auto">
          ...
          <div className="space-y-4 mb-6">
            <div className="h-14 sm:h-16 w-72 mx-auto rounded-lg bg-muted animate-pulse" />
            <div className="h-14 sm:h-16 w-56 mx-auto rounded-lg bg-muted animate-pulse" style={{ animationDelay: "150ms" }} />
          </div>
          <div className="h-4 w-80 max-w-full mx-auto rounded bg-muted animate-pulse mb-12" />
          <div className="max-w-xl mx-auto">
            <div className="flex gap-3 p-2 rounded-xl bg-card border border-border">
              <div className="flex-1 h-12 rounded-lg bg-muted animate-pulse" />
              <div className="w-28 h-12 rounded-lg bg-primary/20 animate-pulse" />
            </div>
          </div>
        </div>
      </main>
