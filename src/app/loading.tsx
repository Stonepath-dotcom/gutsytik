        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-1.5">
              ...
              <div className="w-24 h-9 rounded-lg bg-[#2563EB]/20 animate-pulse" style={{ animationDelay: "300ms" }} />
            </div>
      ...
      <main className="flex-1 pt-16 flex items-center justify-center">
        <div className="text-center px-6 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-[#27272A] mb-8">
            <div className="w-2 h-2 rounded-full bg-[#2563EB]/30 animate-pulse" />
          ...
          <div className="max-w-xl mx-auto">
            <div className="flex gap-3 p-2 rounded-xl bg-[#111113] border border-[#27272A]">
              ...
              <div className="w-28 h-12 rounded-lg bg-[#2563EB]/20 animate-pulse" />
            </div>
          </div>
        </div>
      </main>
