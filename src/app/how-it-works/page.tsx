          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            ...
            <nav aria-label="Breadcrumb" className="mb-8">
              <ol className="flex items-center gap-1.5 text-sm text-muted-foreground">
                ...
                <li className="text-[#E52222] font-medium">Cara Kerja</li>
              </ol>
            </nav>
            ...
            <div className="text-center mb-16">
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium tracking-wider uppercase border border-border text-muted-foreground mb-6">
                <Zap className="h-3 w-3 text-[#E52222]" />
                Cara Kerja
              </span>
              <h1
              ...
              >
                Bagaimana{" "}
                <span className="font-bold text-[#E52222]">Mova</span> Bekerja?
              </h1>
            ...
            <div className="mb-16">
              <div className="text-center mb-10">
                <h2
                  ...
                  style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}
                >
                  Langkah-Langkah <span className="text-[#E52222]">Mengunduh Video</span>
                </h2>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-3">
                          <step.icon className="h-5 w-5 text-[#E52222]" />
                          <h3
            ...
            <div className="mb-16">
              <div className="text-center mb-10">
                <h2
                  ...
                  style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}
                >
                  Teknologi di Balik <span className="text-[#E52222]">Mova</span>
                </h2>
                <p className="text-sm text-muted-foreground max-w-lg mx-auto">
                ...
                {technologies.map((tech, index) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-background border border-border mb-4 group-hover:border-[#E52222]/30 transition-colors">
                      <tech.icon className="h-5 w-5 text-[#E52222]" />
                    </div>
                    <h3
            ...
            <div className="mb-16">
              <div className="text-center mb-10">
                <h2
                  ...
                  style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}
                >
                  Keamanan & <span className="text-[#E52222]">Privasi</span>
                </h2>
                <p className="text-sm text-muted-foreground max-w-lg mx-auto">
                  ...
                  <div key={index} className="flex gap-4">
                    <div className="flex flex-col items-center shrink-0">
                      <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-card border border-border">
                        <point.icon className="h-5 w-5 text-[#E52222]" />
                      </div>
            ...
            <div className="mb-16">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-card border border-border shrink-0">
                  <Download className="h-5 w-5 text-[#E52222]" />
                </div>
                <h2
                  className="text-xl font-bold text-foreground"
                  style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}
            ...
            <div className="mb-16">
              <div className="text-center mb-10">
                <h2
                  ...
                  style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}
                >
                  Format & <span className="text-[#E52222]">Kualitas</span>
                </h2>
                <p className="text-sm text-muted-foreground max-w-lg mx-auto">
                  ...
                  >
                    <div className="flex items-center gap-3 mb-4">
                      <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-background border border-border">
                        <format.icon className="h-5 w-5 text-[#E52222]" />
                      </div>
                      <h3
                        className="text-base font-bold text-foreground"
                        style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}
                    ...
                    <div className="space-y-4">
                      {format.items.map((item, index) => (
                        <div key={index} className="pl-4 border-l-2 border-[#E52222]/30">
            ...
            <div className="mb-16">
              <div className="text-center mb-10">
                <h2
                  ...
                  style={{ fontFamily: "var(--font-montserrat), 'Montserrat', sans-serif" }}
                >
                  Pertanyaan <span className="text-[#E52222]">Umum</span>
                </h2>
                <p className="text-sm text-muted-foreground max-w-lg mx-auto">
