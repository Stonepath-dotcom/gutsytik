      ...
      <div className="min-h-screen flex flex-col bg-white dark:bg-[#09090B] text-foreground dark:text-[#FAFAFA]">
        ...
        <main className="flex-1">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
              ...
              <div className="ml-14 grid sm:grid-cols-3 gap-4">
                {contactMethods.map((method, index) => (
                  <a
                    ...
                    className="p-5 rounded-xl bg-card dark:bg-[#111113] border border-border dark:border-[#27272A] hover:border-[#4F46E5]/30 transition-colors group block"
                  >
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center bg-background dark:bg-[#09090B] border border-border dark:border-[#27272A] mb-3 group-hover:border-[#4F46E5]/30 transition-colors">
            ...
            <div className="mb-12 p-5 rounded-xl bg-card dark:bg-[#111113] border-l-4 border-[#4F46E5]">
