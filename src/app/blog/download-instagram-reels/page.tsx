    ...
    <div className="min-h-screen flex flex-col bg-[#09090B] text-[#FAFAFA]">
      ...
      <main className="flex-1">
        <article className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          {/* Article header */}
          <div className="mb-10">
            <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold mb-4" style={{ background: "linear-gradient(135deg, #833AB4, #FD1D1D, #F77737)", color: "white" }}>
              Instagram
            </span>
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-[#FAFAFA] mb-4 leading-tight">
              Download Video Instagram Reels Tanpa Watermark
            </h1>
            <p className="text-[#A1A1AA] text-sm leading-relaxed mb-4">
              Panduan lengkap cara menyimpan video Instagram Reels tanpa watermark menggunakan Mova. Cepat, gratis, dan berkualitas tinggi.
            </p>
