...
import { ArrowRight, Calendar, Clock, Home, ChevronRight, Sparkles, Search } from "lucide-react";
...
const articles = [
  ...
  },
  {
    ...
    date: "26 Mei 2026",
    readingTime: "9 menit",
    gradient: "from-[#E52222]/20 via-[#FF6B35]/15 to-[#E52222]/10",
    icon: "🏆",
  },
  {
  ...
  },
  {
    ...
    gradient: "from-[#E52222]/20 via-[#FF6B35]/15 to-[#0C0C0E]",
    icon: "📺",
  },
  {
    ...
    date: "25 Mei 2026",
    readingTime: "9 menit",
    gradient: "from-[#FF0000]/20 via-[#282828]/30 to-[#E52222]/10",
    icon: "🌐",
  },
  {
  ...
  },
  {
    ...
    date: "19 Mei 2026",
    readingTime: "7 menit",
    gradient: "from-[#FF6B35]/20 via-[#EC4899]/15 to-[#FF6B35]/10",
    icon: "🎧",
  },
  {
  ...
  },
  {
    ...
    date: "17 Mei 2026",
    readingTime: "8 menit",
    gradient: "from-[#E52222]/20 via-[#C91C1C]/15 to-[#0C0C0E]",
    icon: "🛡️",
  },
  {
  ...
  },
  {
    ...
    date: "11 Mei 2026",
    readingTime: "5 menit",
    gradient: "from-[#FF0000]/15 via-[#282828]/20 to-[#FF6B35]/10",
    icon: "🎧",
  },
  {
    ...
    date: "10 Mei 2026",
    readingTime: "7 menit",
    gradient: "from-[#E52222]/15 via-[#EC4899]/10 to-[#0C0C0E]",
    icon: "📊",
  },
  {
  ...
  },
  {
    ...
    date: "7 Mei 2026",
    readingTime: "8 menit",
    gradient: "from-[#FF6B35]/20 via-[#EC4899]/15 to-[#E52222]/10",
    icon: "🎵",
  },
  {
    ...
    date: "6 Mei 2026",
    readingTime: "10 menit",
    gradient: "from-[#FF0000]/20 via-[#E52222]/15 to-[#0C0C0E]",
    icon: "⭐",
  },
  {
    ...
    date: "5 Mei 2026",
    readingTime: "9 menit",
    gradient: "from-[#E52222]/15 via-[#E52222]/10 to-[#0C0C0E]",
    icon: "📶",
  },
];

export default function BlogPage() {
  // Merge auto-generated posts with static articles (auto-generated first as "latest")
  ...
  const allArticles = [...autoPosts, ...articles];
        ...
        <main className="flex-1">
          ...
          <div className="mx-auto max-w-5xl px-4 pt-6">
            <nav aria-label="Breadcrumb">
              <ol className="flex items-center gap-1.5 text-sm text-muted-foreground">
                ...
                <li className="text-[#E52222] font-medium">Blog</li>
              </ol>
            </nav>
          </div>
          ...
          <section className="relative pt-8 pb-12 px-4 sm:px-6 overflow-hidden">
            <div className="relative mx-auto max-w-4xl text-center">
              ...
              {/* Blog Search */}
              <BlogSearchClient articles={allArticles.map(a => ({ slug: a.slug, title: a.title, description: a.description, date: a.date, readingTime: a.readingTime, gradient: a.gradient, icon: a.icon, image: (a as any).image || null, isAutoGenerated: !!(a as any).isAutoGenerated }))} />
            </div>
          </section>
