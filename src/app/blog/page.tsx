...
import { ArrowRight, Calendar, Clock, Home, ChevronRight, Sparkles } from "lucide-react";
                  ...
                  {autoPosts.map((article) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="absolute top-3 right-3 px-2 py-0.5 rounded-full bg-[#10B981] text-[9px] font-bold text-white">
                          BARU
                        </span>
                      </div>
