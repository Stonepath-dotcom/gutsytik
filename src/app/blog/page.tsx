        ...
        <main className="flex-1">
          ...
          <section className="relative pt-8 pb-12 px-4 sm:px-6 overflow-hidden">
            <div className="relative mx-auto max-w-4xl text-center">
              ...
              {/* Blog Search */}
              <BlogSearchClient articles={allArticles.map(a => ({ slug: a.slug, title: a.title, description: a.description, date: a.date, readingTime: a.readingTime, gradient: a.gradient, icon: a.icon, image: a.image || null, isAutoGenerated: !!(a as any).isAutoGenerated }))} />
            </div>
          </section>
