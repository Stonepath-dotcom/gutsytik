          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            ...
            <nav aria-label="Breadcrumb" className="mb-8">
              <ol className="flex items-center gap-1.5 text-sm text-[#A1A1AA]">
                ...
                <li><ChevronRight className="h-3.5 w-3.5" /></li>
                <li className="text-[#F97316] font-medium">Download Video Telegram</li>
              </ol>
            </nav>
            ...
            <article className="max-w-none space-y-8">
              ...
              <div className="p-4 rounded-lg bg-[#F97316]/10 border border-[#F97316]/20 mt-4">
              ...
              <p className="text-sm text-[#A1A1AA] leading-relaxed">
                Kalau metode pertama nggak bisa — misalnya karena video di channel yang restrict forwarding — kamu bisa menggunakan <a href="/" className="text-[#F97316] hover:underline">Mova</a> sebagai alternatif. Mova mendukung download video dari link Telegram. Begini caranya:
              </p>
              <div className="space-y-4 mt-4">
                <div className="flex items-start gap-3 p-4 rounded-lg bg-[#111113] border border-[#27272A]">
                  <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[#F97316] text-white text-xs font-bold flex items-center justify-center">1</span>
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-[#111113] border border-[#27272A]">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#A1A1AA] mt-1">Kunjungi <a href="/" className="text-[#F97316] hover:underline">getmova.my.id</a> dari browser HP atau laptop kamu.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 rounded-lg bg-[#111113] border border-[#27272A]">
                  <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[#F97316] text-white text-xs font-bold flex items-center justify-center">3</span>
              ...
              <ul className="space-y-2 mt-3">
                ...
                <li className="flex items-start gap-2 text-sm text-[#A1A1AA]">
                  <span className="text-[#F97316] mt-1">&#8226;</span>
                  <span><strong className="text-[#FAFAFA]">Perhatikan hak cipta</strong> — Beberapa video di channel Telegram berisi konten berhak cipta. Download untuk penggunaan pribadi dan jangan distribusikan ulang tanpa izin. Baca <a href="/disclaimer" className="text-[#F97316] hover:underline">disclaimer</a> kami untuk informasi lebih lanjut.</span>
                </li>
              </ul>
              ...
              <p className="text-sm text-[#A1A1AA] leading-relaxed">
                Meskipun Telegram sudah punya fitur save video bawaan, <a href="/" className="text-[#F97316] hover:underline">Mova</a> tetap berguna di beberapa situasi: ketika video nggak bisa di-forward, ketika kamu mau download di perangkat yang berbeda, atau ketika kamu butuh link download langsung yang bisa dibagikan. Ditambah lagi, Mova juga bisa digunakan untuk <a href="/tiktok-downloader" className="text-[#F97316] hover:underline">download TikTok</a>, <a href="/youtube-downloader" className="text-[#F97316] hover:underline">YouTube</a>, dan <a href="/instagram-downloader" className="text-[#F97316] hover:underline">Instagram</a>. Semua dalam satu tempat, gratis, dan tanpa iklan mengganggu.
              </p>
              <p className="text-sm text-[#A1A1AA] leading-relaxed">
                Untuk informasi lebih lanjut, kamu juga bisa membaca panduan <a href="/blog/cara-download-video-pinterest" className="text-[#F97316] hover:underline">download video Pinterest</a> dan <a href="/blog/download-video-tanpa-watermark-terbaik" className="text-[#F97316] hover:underline">situs download video tanpa watermark terbaik</a> di blog kami.
              </p>
            </article>
