          ...
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
            ...
            <nav aria-label="Breadcrumb" className="mb-8">
              <ol className="flex items-center gap-1.5 text-sm text-[#A1A1AA]">
                ...
                <li><ChevronRight className="h-3.5 w-3.5" /></li>
                <li className="text-[#F97316] font-medium">Download IG Story & Reels</li>
              </ol>
            </nav>
            ...
            <article className="max-w-none space-y-8">
              ...
              <p className="text-sm text-[#A1A1AA] leading-relaxed">
                Download Reels jauh lebih mudah karena setiap Reels punya URL yang bisa di-copy. Berikut langkah-langkahnya menggunakan <a href="/" className="text-[#F97316] hover:underline">Mova</a>:
              </p>
              ...
              <div className="space-y-4 mt-4">
                ...
                <div className="flex items-start gap-3 p-4 rounded-lg bg-[#111113] border border-[#27272A]">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-[#A1A1AA] mt-1">Buka <a href="/" className="text-[#F97316] hover:underline">Mova</a>, masukkan username Instagram ke kolom input, lalu klik Download. Mova akan mendeteksi Story yang sedang aktif dari akun tersebut.</p>
                  </div>
                </div>
                <div className="flex items-start gap-3 p-4 rounded-lg bg-[#111113] border border-[#27272A]">
                  <span className="flex-shrink-0 w-7 h-7 rounded-full bg-[#F97316] text-white text-xs font-bold flex items-center justify-center">3</span>
              ...
              <p className="text-sm text-[#A1A1AA] leading-relaxed">
                Dari semua tool yang ada, <a href="/" className="text-[#F97316] hover:underline">Mova</a> adalah pilihan paling lengkap untuk download konten Instagram. Bukan cuma Story dan Reels, Mova juga bisa download foto, video feed, dan IGTV. Selain itu, Mova juga mendukung <a href="/tiktok-downloader" className="text-[#F97316] hover:underline">download TikTok</a>, <a href="/youtube-downloader" className="text-[#F97316] hover:underline">YouTube</a>, dan platform lainnya. Semua dalam satu situs, tanpa perlu install apapun, dan 100% gratis.
              </p>
              <p className="text-sm text-[#A1A1AA] leading-relaxed">
                Untuk informasi lebih lanjut, kamu juga bisa membaca panduan <a href="/blog/download-video-tanpa-watermark-terbaik" className="text-[#F97316] hover:underline">situs download video terbaik</a> dan <a href="/blog/cara-download-video-pinterest" className="text-[#F97316] hover:underline">cara download video Pinterest</a> di blog kami. Jangan lupa juga untuk membaca <a href="/privacy" className="text-[#F97316] hover:underline">kebijakan privasi</a> kami.
              </p>
            </article>
