          ...
          <div className="prose-sm space-y-8">
                ...
                <table className="w-full text-sm">
                  <thead>
                    <tr className="border-b border-[#27272A]">
                      ...
                      <th className="text-left py-3 px-3 text-[#F97316] font-semibold">MP4 (Video)</th>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2 text-sm text-[#A1A1AA]">
                    <Film className="h-4 w-4 text-[#F97316] mt-0.5 shrink-0" />
            ...
            <section>
              ...
              <ul className="space-y-2">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2 text-sm text-[#A1A1AA]">
                    <Music className="h-4 w-4 text-[#F97316] mt-0.5 shrink-0" />
                    <span><strong className="text-[#FAFAFA]">{item.title}:</strong> {item.desc}</span>
                  </li>
                ))}
              </ul>
            ...
            <section>
              ...
              <div className="mt-8 p-6 rounded-xl bg-[#111113] border border-[#F97316]/30 text-center">
                ...
                <a href="/youtube-downloader" className="inline-flex items-center gap-2 px-5 py-2 rounded-lg text-sm font-semibold bg-[#F97316] text-white hover:bg-[#EA580C] transition-colors">Coba Mova Sekarang <ArrowRight className="h-4 w-4" /></a>
              </div>
            </section>
          </div>
          ...
          <div className="mt-16 pt-8 border-t border-[#27272A]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <a href="/blog/download-youtube-mp3" className="flex items-center justify-between p-4 rounded-lg border border-[#27272A] bg-[#111113] hover:border-[#F97316]/50 transition-colors group">
                <span className="text-sm text-[#A1A1AA] group-hover:text-[#FAFAFA]">Download YouTube ke MP3</span><ArrowRight className="h-4 w-4 text-[#A1A1AA] group-hover:text-[#F97316] transition-colors" />
              </a>
