...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const blogs: { slug: string; date: string }[] = [
    ...
    { slug: "cara-download-video-youtube-mp4", date: "2025-05-12" },
    ...
    { slug: "download-video-youtube-tanpa-aplikasi", date: "2025-05-19" },
    ...
    { slug: "download-youtube-mp3", date: "2025-05-23" },
    ...
    { slug: "cara-download-video-youtube-hd-1080p", date: "2025-05-24" },
    ...
    { slug: "perbandingan-youtube-downloader-terbaik", date: "2025-05-26" },
