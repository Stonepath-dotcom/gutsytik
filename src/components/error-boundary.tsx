          ...
          <div className="relative z-10 text-center max-w-md">
            ...
            <div className="flex justify-center mb-8">
              <div className="w-20 h-20 rounded-2xl bg-[#111113] border border-[#27272A] flex items-center justify-center">
                <AlertCircle className="h-10 w-10 text-[#2563EB]" />
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mt-8">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 rounded-lg text-white font-semibold transition-all btn-press bg-[#2563EB] hover:bg-[#1D4ED8]"
              >
