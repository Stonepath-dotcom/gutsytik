          ...
          <div className="bg-card/80 backdrop-blur-xl border border-border rounded-xl p-4 shadow-lg shadow-black/20">
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-[#E52222] hover:bg-[#C91C1C] text-white text-sm font-semibold transition-all btn-press"
              >
