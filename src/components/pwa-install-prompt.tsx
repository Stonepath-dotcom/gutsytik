          ...
          <div className="bg-[#111113] border border-[#27272A] rounded-xl p-4 shadow-lg shadow-black/20">
            ...
            <div className="mt-3 flex gap-2">
              <button
                ...
                className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-[#10B981] hover:bg-[#059669] text-white text-sm font-semibold transition-all btn-press"
              >
