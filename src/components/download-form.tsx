    ...
    <div className="w-full max-w-xl mx-auto">
      ...
      <div className="relative flex items-center gap-2">
        ...
        <Button
          ...
          disabled={loading}
          className="h-11 px-5 bg-[#4F46E5] text-white font-semibold rounded-xl hover:bg-[#4338CA] shrink-0"
        >
          {loading ? (
      ...
      {/* Loading */}
      {loading && !error && (
        <div className="mt-3 p-3 rounded-lg bg-[#4F46E5]/10 border border-[#4F46E5]/20 flex items-center gap-2">
      ...
      {result && (
        <div
          ...
          style={{ borderColor: "#4F46E530" }}
        >
          {/* Header */}
          <div
            className="px-4 py-2 border-b border-border flex items-center gap-2"
            style={{ background: "linear-gradient(to right, #4F46E515, #7C3AED15)" }}
          >
          ...
          <div className="p-4">
            ...
            <Button
              ...
              className="w-full bg-[#4F46E5] text-white font-semibold rounded-xl hover:bg-[#4338CA] h-10"
            >
              {downloading ? (
