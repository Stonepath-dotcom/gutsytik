...
export function AuthorBox() {
  return (
    <div className="flex items-start gap-4 p-5 rounded-xl bg-card border border-border mt-8">
      <div className="w-12 h-12 rounded-full bg-[#10B981]/20 border-2 border-[#10B981] flex items-center justify-center shrink-0">
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="inline-flex items-center gap-1 px-1.5 py-0.5 rounded-md bg-[#10B981]/10 text-[10px] font-bold text-[#10B981]">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 text-xs text-muted-foreground hover:text-[#10B981] transition-colors"
        >
